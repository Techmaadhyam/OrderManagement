...
export const QuotationOrderEditForm = (props) => {
  //get state using react router hook
  ...
  //get quotation parts rows for given id
  useEffect(() => {
    axios
      .get(
  ...
  useEffect(() => {
    ...
    const request2 = axios.get(apiUrl + `getAllUsersBasedOnType/${userId}`); //this gets registed users (from registeration page)
